...
export default function Commands() {
  return (
    <>
      <h1 id="welcome-title">명령어</h1>
      <Text fontSize="xl">음악</Text>
      <li>재생[play] (재목) 음악을 재생합니다</li>
